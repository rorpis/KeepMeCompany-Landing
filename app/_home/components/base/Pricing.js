...
const PricingCard = ({ title, price, description, features, buttonText, highlighted }) => (
  <div className="relative">
    ...
    <div className={`p-5 rounded-xl border ${highlighted ? 'border-[--color-company-blue]' : 'border-gray-800'} bg-transparent relative`}>
      ...
      <div className="relative">
        ...
        <div className="p-5 flex flex-col h-full">
          ...
          <ul className="space-y-1.5 mb-6 flex-grow h-32">
          ...
          <div className="flex justify-center">
            <a 
              ...
              className={`w-1/2 py-1.5 px-3 rounded-lg ${highlighted ? 'bg-[--color-company-blue] hover:bg-opacity-90' : 'bg-white hover:bg-gray-100'} text-${highlighted ? 'white' : 'gray-900'} font-semibold transition-colors text-sm text-center`}
            >
              {buttonText}
            </a>
          </div>
...
const PricingSection = () => {
  ...
  return (
    <div className="mx-auto w-[85%] py-12 bg-black">
      <div className="mb-10">
        <h1 className="text-3xl font-semibold text-white mb-3">Pricing</h1>
        <p className="text-gray-400 text-base">Choose your ideal package</p>
      </div>
